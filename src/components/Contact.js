          ...
          <Col size={12} md={6}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <h2>Get In Touch</h2>
                <form action="https://formsubmit.co/df68fcf2ef961f6c66af2e57914f522b" method="POST" onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      ...
                      <input type="hidden" name="_next" value="https://johnzxia030.github.io/personal-portfolio/#/thank-you"></input>
                    </Col>
